...
{
    public function __construct(private MinecraftMapTileService $minecraftMapTileService) {}
    ...
    public function manifest(ReadMapRegionRequest $request): JsonResponse
    {
        ...
        try {
            $manifest = $this->minecraftMapTileService->getManifest($region !== '' ? $region : null);
    ...
    public function tile(ReadMapRegionRequest $request, int $zoom, int $x, int $y): BinaryFileResponse
    {
        ...
        try {
            $tilePath = $this->minecraftMapTileService->getTilePath($zoom, $x, $y, $region !== '' ? $region : null);
        } catch (RuntimeException $exception) {
